...
all: Token.o LexAnalyzer.o SyntaxAnalyzer.o Compiler.o main.o 
	g++ main.o Token.o LexAnalyzer.o SyntaxAnalyzer.o Compiler.o -o main   

clean:
	if [ -f Token.o ]; then rm Token.o; fi
	if [ -f Compiler.o ]; then rm Compiler.o; fi
	if [ -f LexAnalyzer.o ]; then rm LexAnalyzer.o; fi
	if [ -f SyntaxAnalyzer.o ]; then rm SyntaxAnalyzer.o; fi
...
SyntaxAnalyzer.o: SyntaxAnalyzer.h SyntaxAnalyzer.cpp
